  ...
  console.log("EndGame.js")
      ...
      GameData.find({}, (err, data) => {
        ...
        for (let i = 0;i<numberOfRounds;i++){
          ...
          worksheetRetailer.addRow([i,roundDataLastGame.retailer[i].stock,roundDataLastGame.retailer[i].order,roundDataLastGame.retailer[i].retard,roundDataLastGame.retailer[i].next1Week,roundDataLastGame.retailer[i].next2Week])
          worksheetWholesaler.addRow([i,roundDataLastGame.wholesaler[i].stock,roundDataLastGame.wholesaler[i].order,roundDataLastGame.wholesaler[i].retard,roundDataLastGame.wholesaler[i].next1Week,roundDataLastGame.wholesaler[i].next2Week])
          worksheetDistributor.addRow([i,roundDataLastGame.distributor[i].stock,roundDataLastGame.distributor[i].order,roundDataLastGame.distributor[i].retard,roundDataLastGame.distributor[i].next1Week,roundDataLastGame.distributor[i].next2Week])
          worksheetProducer.addRow([i,roundDataLastGame.producer[i].stock,roundDataLastGame.producer[i].order,roundDataLastGame.producer[i].retard,roundDataLastGame.producer[i].next1Week,roundDataLastGame.producer[i].next2Week])
        }
